...
import (
	...
	riomodule "rio/x/rio"
	riomodulekeeper "rio/x/rio/keeper"
	riomoduletypes "rio/x/rio/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "rio"
	Name                 = "rio"
)
...
type App struct {
	*baseapp.BaseApp
	...
	RioKeeper riomodulekeeper.Keeper
...
func New(
	...
	app.RioKeeper = *riomodulekeeper.NewKeeper(
		appCodec,
		keys[riomoduletypes.StoreKey],
		keys[riomoduletypes.MemStoreKey],
		app.GetSubspace(riomoduletypes.ModuleName),
	)
	rioModule := riomodule.NewAppModule(appCodec, app.RioKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(riomoduletypes.ModuleName)
